...
export class BackButtonFp {
  constructor({ postEvent, version, isTma, ...rest }: BackButtonOptions) {
    ...
    const wrapSupported = createWrapSafeFp(wrapOptions);
    const wrapComplete = createWrapSafeFp({
      ...wrapOptions,
   ...
   * @since Mini Apps v6.1
   */
  readonly hide: SafeWrappedFp<() => void, true>;

  /**
   * Shows the back button.
   * @since Mini Apps v6.1
   */
  readonly show: SafeWrappedFp<() => void, true>;
   ...
   * });
   */
  readonly onClick: SafeWrappedFp<
   ...
   */
  readonly offClick: SafeWrappedFp<
   ...
   * @since Mini Apps v6.1
   */
  readonly mount: SafeWrappedFp<() => void, true>;
