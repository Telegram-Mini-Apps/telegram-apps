---
sidebar_position: 1
sidebar_label: "twa-bridge"
---

# twa-bridge <sup><img src="https://static.npmjs.com/255a118f56f5346b97e56325a1217a16.svg" alt="drawing" width="20"/></sup>
...
<div style={{marginBottom: 10}}>
  <a href={"https://npmjs.com/package/twa-bridge"}>
    <img alt={"npm"} src={"https://img.shields.io/npm/v/twa-bridge?logo=npm"}/>
  </a>

  <img
    alt={"size"}
    style={{marginLeft: 10}}
    src={"https://img.shields.io/bundlephobia/minzip/twa-bridge"}
  />
</div>
...
[SDK](twa-sdk/general), which implements bridge methods. It also provides
