...
it('should return launch parameters from the session storage tma.js/launch-params key. If data is missing or invalid, throw an error', () => {
  const spy = vi
  ...
  expect(spy).toHaveBeenCalledWith('tma.js/launch-params');
});