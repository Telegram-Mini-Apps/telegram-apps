...
import { MiniAppsMessage } from '@telegram-apps/transformers';
...
function listener(event: MessageEvent): void {
  ...
  let message: InferOutput<typeof MiniAppsMessage>;
  try {
    message = parse(pipe(string(), transform(JSON.parse), MiniAppsMessage), event.data);
  } catch {
...
export const [
  ...
  () => {
    ...
    const obj = { receiveEvent: emitMiniAppsEvent };
    w.TelegramGameProxy_receiveEvent = emitMiniAppsEvent;
    ...
    // generated by the local emitMiniAppsEvent function.
