  ...
  describe('Bridge', () => {
    ...
    describe('events handling', () => {
      ...
      it('should log error message into console if debug mode is '
        ...
        expect(consoleErrorSpy).toBeCalledWith(
          '[10:10:00.300]',
          '[Bridge]',
          'Error processing Telegram event:',
    ...
    describe('postEvent', () => {
      it('should call package postEvent function with event '
        ...
        expect(postEventSpy).toBeCalledWith('web_app_close', { targetOrigin: 'custom origin' });
      });
