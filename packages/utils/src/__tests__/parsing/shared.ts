...
describe('parsing', () => {
  describe('shared', () => {
    describe('schemaToParsers', () => {
      it(
        'should return element with parser specified as value ' +
        'for field in schema', () => {
          const fn = jest.fn();
      ...
      it(
        'should return element with predefined parser from known ' +
        'parsers map', () => {
          const known = jest.fn();
      ...
      it(
        'should return element with all options described in ' +
        'schema field', () => {
          const fn = jest.fn();
          const knownParsers: Record<string, () => void> = {};
