...
- 5e4f543: Make changes according to those, done in the SDK. Provider now automatically correctly performs cleanup on unmount and allows initializing components with their own cleanups. Hooks now works more clear in SSR mode.
