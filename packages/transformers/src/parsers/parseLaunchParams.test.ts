...
import { parseLaunchParams } from '@/parsers/parseLaunchParams.js';
...
it('should properly parse the value', () => {
  ...
  expect(parseLaunchParams(input)).toStrictEqual(output);
  expect(parseLaunchParams(input, false)).toStrictEqual(output);
});
