...
Пакет, который предоставляет утилиты для работы с данными инициализации Telegram Mini Apps на клиентской стороне. Чтобы узнать больше о данных инициализации и их использовании, пожалуйста, обратитесь к [документации](../launch-params/init-data.mdx).
...
Мы переместили утилиты проверки в отдельный [пакет TypeScript](tma-js-init-data-node.mdx). Эти утилиты необходимы только на стороне сервера, так как нет необходимости проверять данные
