...
简而言之，所有迷你应用程序都是典型的网络应用程序，每个应用程序都需要自己的 URL，
，以检索和显示应用程序的内容。 Telegram 不为
...
在深入了解本指南之前，重要的是要了解为什么需要一些链接。 大多数情况下，
，我们需要应用链接来实现以下目的之一：
...
，仅用于开发目的。 让它类似于 `tma.internal`。 为了让当前设备
...
要解决这个问题，需要创建某种链接，作为连接本地 IP 的隧道。 为此，
，我们使用第三方有条件免费服务，如 [ngrok](https://ngrok.com/)
