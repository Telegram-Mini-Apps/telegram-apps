---
sidebar_label: "@tma.js/sdk-react"
sidebar_position: 5
---

# @tma.js/sdk-react

React bindings for the [client SDK](tma-js-sdk/about). It includes hooks, components, and other useful tools that enable the use of React alongside the Web Apps client SDK. It automatically tracks changes to SDK components.
...
It will return the result of the [`retrieveLaunchParams`](tma-js-sdk/about#launch-parameters) function.
